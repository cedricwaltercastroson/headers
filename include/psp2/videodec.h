...
typedef enum SceAvcdecErrorCode {
	SCE_AVCDEC_ERROR_INVALID_TYPE                 = (int)0x80620001,
	SCE_AVCDEC_ERROR_INVALID_PARAM                = (int)0x80620002,
	SCE_AVCDEC_ERROR_OUT_OF_MEMORY                = (int)0x80620003,
	SCE_AVCDEC_ERROR_INVALID_STATE                = (int)0x80620004,
	SCE_AVCDEC_ERROR_UNSUPPORT_IMAGE_SIZE         = (int)0x80620005,
	SCE_AVCDEC_ERROR_INVALID_COLOR_FORMAT         = (int)0x80620006,
	SCE_AVCDEC_ERROR_NOT_PHY_CONTINUOUS_MEMORY    = (int)0x80620007,
	SCE_AVCDEC_ERROR_ALREADY_USED                 = (int)0x80620008,
	SCE_AVCDEC_ERROR_INVALID_POINTER              = (int)0x80620009,
	SCE_AVCDEC_ERROR_ES_BUFFER_FULL               = (int)0x8062000A,
	SCE_AVCDEC_ERROR_INITIALIZE                   = (int)0x8062000B,
	SCE_AVCDEC_ERROR_NOT_INITIALIZE               = (int)0x8062000C,
	SCE_AVCDEC_ERROR_INVALID_STREAM               = (int)0x8062000D,
	SCE_AVCDEC_ERROR_INVALID_ARGUMENT_SIZE        = (int)0x8062000E
} SceAvcdecErrorCode;
