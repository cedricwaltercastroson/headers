...
typedef enum ScePspnetAdhocErrorCode {
	SCE_ERROR_NET_ADHOC_INVALID_SOCKET_ID      = (int)0x80410701,
	SCE_ERROR_NET_ADHOC_INVALID_ADDR           = (int)0x80410702,
	SCE_ERROR_NET_ADHOC_INVALID_PORT           = (int)0x80410703,
	SCE_ERROR_NET_ADHOC_INVALID_BUFLEN         = (int)0x80410704,
	SCE_ERROR_NET_ADHOC_INVALID_DATALEN        = (int)0x80410705,
	SCE_ERROR_NET_ADHOC_NOT_ENOUGH_SPACE       = (int)0x80410706,
	SCE_ERROR_NET_ADHOC_SOCKET_DELETED         = (int)0x80410707,
	SCE_ERROR_NET_ADHOC_SOCKET_ALERTED         = (int)0x80410708,
	SCE_ERROR_NET_ADHOC_WOULD_BLOCK            = (int)0x80410709,
	SCE_ERROR_NET_ADHOC_PORT_IN_USE            = (int)0x8041070A,
	SCE_ERROR_NET_ADHOC_NOT_CONNECTED          = (int)0x8041070B,
	SCE_ERROR_NET_ADHOC_DISCONNECTED           = (int)0x8041070C,
	SCE_ERROR_NET_ADHOC_NOT_OPENED             = (int)0x8041070D,
	SCE_ERROR_NET_ADHOC_NOT_LISTENED           = (int)0x8041070E,
	SCE_ERROR_NET_ADHOC_SOCKET_ID_NOT_AVAIL    = (int)0x8041070F,
	SCE_ERROR_NET_ADHOC_PORT_NOT_AVAIL         = (int)0x80410710,
	SCE_ERROR_NET_ADHOC_INVALID_ARG            = (int)0x80410711,
	SCE_ERROR_NET_ADHOC_NOT_INITIALIZED        = (int)0x80410712,
	SCE_ERROR_NET_ADHOC_ALREADY_INITIALIZED    = (int)0x80410713,
	SCE_ERROR_NET_ADHOC_BUSY                   = (int)0x80410714,
	SCE_ERROR_NET_ADHOC_TIMEOUT                = (int)0x80410715,
	SCE_ERROR_NET_ADHOC_NO_ENTRY               = (int)0x80410716,
	SCE_ERROR_NET_ADHOC_EXCEPTION_EVENT        = (int)0x80410717,
	SCE_ERROR_NET_ADHOC_CONNECTION_REFUSED     = (int)0x80410718,
	SCE_ERROR_NET_ADHOC_THREAD_ABORTED         = (int)0x80410719,
	SCE_ERROR_NET_ADHOC_ALREADY_CREATED        = (int)0x8041071A,
	SCE_ERROR_NET_ADHOC_NOT_IN_GAMEMODE        = (int)0x8041071B,
	SCE_ERROR_NET_ADHOC_NOT_CREATED            = (int)0x8041071C,
	SCE_ERROR_NET_ADHOC_INVALID_ALIGNMENT      = (int)0x8041071D
