...
typedef enum SceNetCheckDialoErrorCode {
	SCE_NETCHECK_DIALOG_ERROR_PARAM                       = (int)0x80100C01,
	SCE_NETCHECK_DIALOG_ERROR_INVALID_MODE                = (int)0x80100C02,
	SCE_NETCHECK_DIALOG_ERROR_LACK_OF_LIBHTTP_POOL_SIZE   = (int)0x80100C03,
	SCE_NETCHECK_DIALOG_ERROR_LACK_OF_LIBSSL_POOL_SIZE    = (int)0x80100C04,
	SCE_NETCHECK_DIALOG_ERROR_LATEST_PATCH_PKG_EXIST      = (int)0x80100C05,
	SCE_NETCHECK_DIALOG_ERROR_SIGN_OUT                    = (int)0x80100C06,
	SCE_NETCHECK_DIALOG_ERROR_INVALID_PSPADHOC_PARAM      = (int)0x80100C07,
	SCE_NETCHECK_DIALOG_ERROR_INVALID_TIMEOUT_PARAM       = (int)0x80100C08,
	SCE_NETCHECK_DIALOG_ERROR_PSN_AGE_RESTRICTION         = (int)0x80100C09
