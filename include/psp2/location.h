...
typedef enum SceLocationErrorCode {
	...
	SCE_LOCATION_INFO_UNDETERMINED_LOCATION         = (int)0x80101200,
	SCE_LOCATION_INFO_INSUFFICIENT_INFORMATION      = (int)0x80101201,
	SCE_LOCATION_INFO_GET_LOCATION_CANCELED         = (int)0x80101202,
	SCE_LOCATION_INFO_DENIED_BY_USER                = (int)0x80101203,

	SCE_LOCATION_ERROR_INVALID_ADDRESS              = (int)0x80101204,
	SCE_LOCATION_ERROR_INVALID_HANDLE               = (int)0x80101205,
	SCE_LOCATION_ERROR_NO_MEMORY                    = (int)0x80101206,
	SCE_LOCATION_ERROR_TOO_MANY_HANDLES             = (int)0x80101207,
	SCE_LOCATION_ERROR_INVALID_LOCATION_METHOD      = (int)0x80101208,
	SCE_LOCATION_ERROR_INVALID_HEADING_METHOD       = (int)0x80101209,
	SCE_LOCATION_ERROR_MULTIPLE_CALLBACK            = (int)0x8010120A,
	SCE_LOCATION_ERROR_NOT_RUNNING_CALLBACK         = (int)0x8010120B,
	SCE_LOCATION_ERROR_DIALOG_RESULT_NONE           = (int)0x8010120C,
	SCE_LOCATION_ERROR_DISABLE_APPLICATION          = (int)0x8010120D,
	SCE_LOCATION_ERROR_MULTIPLE_CONFIRM             = (int)0x8010120E,

	SCE_LOCATION_ERROR_UNAUTHORIZED                 = (int)0x80101280,
	SCE_LOCATION_ERROR_PROVIDER_UNAVAILABLE         = (int)0x80101281,
	SCE_LOCATION_ERROR_FILE_IO                      = (int)0x80101282,
	SCE_LOCATION_ERROR_INVALID_FILE_FORMAT          = (int)0x80101283,
	SCE_LOCATION_ERROR_TIME_OUT                     = (int)0x80101284,
	SCE_LOCATION_ERROR_NO_SERVER_MEMORY             = (int)0x80101285,
	SCE_LOCATION_ERROR_INVALID_TITLE_ID             = (int)0x80101286,
	SCE_LOCATION_ERROR_FATAL_ERROR                  = (int)0x801012FF
