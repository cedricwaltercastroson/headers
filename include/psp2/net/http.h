...
typedef enum SceHttpErrorCode {
	SCE_HTTP_ERROR_BEFORE_INIT                  = (int)0x80431001,
	SCE_HTTP_ERROR_ALREADY_INITED               = (int)0x80431020,
	SCE_HTTP_ERROR_BUSY                         = (int)0x80431021,
	SCE_HTTP_ERROR_OUT_OF_MEMORY                = (int)0x80431022,
	SCE_HTTP_ERROR_NOT_FOUND                    = (int)0x80431025,
	SCE_HTTP_ERROR_INVALID_VERSION              = (int)0x8043106A,
	SCE_HTTP_ERROR_INVALID_ID                   = (int)0x80431100,
	SCE_HTTP_ERROR_OUT_OF_SIZE                  = (int)0x80431104,
	SCE_HTTP_ERROR_INVALID_VALUE                = (int)0x804311FE,

	SCE_HTTP_ERROR_INVALID_URL                  = (int)0x80433060,
	SCE_HTTP_ERROR_UNKNOWN_SCHEME               = (int)0x80431061,
	SCE_HTTP_ERROR_NETWORK                      = (int)0x80431063,
	SCE_HTTP_ERROR_BAD_RESPONSE                 = (int)0x80431064,
	SCE_HTTP_ERROR_BEFORE_SEND                  = (int)0x80431065,
	SCE_HTTP_ERROR_AFTER_SEND                   = (int)0x80431066,
	SCE_HTTP_ERROR_TIMEOUT                      = (int)0x80431068,
	SCE_HTTP_ERROR_UNKOWN_AUTH_TYPE             = (int)0x80431069,
	SCE_HTTP_ERROR_UNKNOWN_METHOD               = (int)0x8043106B,
	SCE_HTTP_ERROR_READ_BY_HEAD_METHOD          = (int)0x8043106F,
	SCE_HTTP_ERROR_NOT_IN_COM                   = (int)0x80431070,
	SCE_HTTP_ERROR_NO_CONTENT_LENGTH            = (int)0x80431071,
	SCE_HTTP_ERROR_CHUNK_ENC                    = (int)0x80431072,
	SCE_HTTP_ERROR_TOO_LARGE_RESPONSE_HEADER    = (int)0x80431073,
	SCE_HTTP_ERROR_SSL                          = (int)0x80431075,
	SCE_HTTP_ERROR_ABORTED                      = (int)0x80431080,
	SCE_HTTP_ERROR_UNKNOWN                      = (int)0x80431081,

	SCE_HTTP_ERROR_PARSE_HTTP_NOT_FOUND         = (int)0x80432025,
	SCE_HTTP_ERROR_PARSE_HTTP_INVALID_RESPONSE  = (int)0x80432060,
	SCE_HTTP_ERROR_PARSE_HTTP_INVALID_VALUE     = (int)0x804321FE,

	SCE_HTTP_ERROR_RESOLVER_EPACKET             = (int)0x80436001,
	SCE_HTTP_ERROR_RESOLVER_ENODNS              = (int)0x80436002,
	SCE_HTTP_ERROR_RESOLVER_ETIMEDOUT           = (int)0x80436003,
	SCE_HTTP_ERROR_RESOLVER_ENOSUPPORT          = (int)0x80436004,
	SCE_HTTP_ERROR_RESOLVER_EFORMAT             = (int)0x80436005,
	SCE_HTTP_ERROR_RESOLVER_ESERVERFAILURE      = (int)0x80436006,
	SCE_HTTP_ERROR_RESOLVER_ENOHOST             = (int)0x80436007,
	SCE_HTTP_ERROR_RESOLVER_ENOTIMPLEMENTED     = (int)0x80436008,
	SCE_HTTP_ERROR_RESOLVER_ESERVERREFUSED      = (int)0x80436009,
	SCE_HTTP_ERROR_RESOLVER_ENORECORD           = (int)0x8043600A
} SceHttpErrorCode;

typedef enum SceHttpsErrorCode {
	SCE_HTTPS_ERROR_CERT                        = (int)0x80435060,
	SCE_HTTPS_ERROR_HANDSHAKE                   = (int)0x80435061,
	SCE_HTTPS_ERROR_IO                          = (int)0x80435062,
	SCE_HTTPS_ERROR_INTERNAL                    = (int)0x80435063,
	SCE_HTTPS_ERROR_PROXY                       = (int)0x80435064
} SceHttpsErrorCode;
