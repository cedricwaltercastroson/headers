...
typedef enum ScePvfErrorCode {
	SCE_PVF_ERROR_NOMEMORY         = (int)0x80460001,
	SCE_PVF_ERROR_LIBID            = (int)0x80460002,
	SCE_PVF_ERROR_ARG              = (int)0x80460003,
	SCE_PVF_ERROR_NOFILE           = (int)0x80460004,
	SCE_PVF_ERROR_FILEOPEN         = (int)0x80460005,
	SCE_PVF_ERROR_FILECLOSE        = (int)0x80460006,
	SCE_PVF_ERROR_FILEREAD         = (int)0x80460007,
	SCE_PVF_ERROR_FILESEEK         = (int)0x80460008,
	SCE_PVF_ERROR_TOOMANYOPENED    = (int)0x80460009,
	SCE_PVF_ERROR_ILLEGALVERSION   = (int)0x8046000A,
	SCE_PVF_ERROR_DATAINCONSISTENT = (int)0x8046000B,
	SCE_PVF_ERROR_EXPIRED          = (int)0x8046000C,
	SCE_PVF_ERROR_NOSUPPORT        = (int)0x8046000E,
	SCE_PVF_ERROR_NOGLYPH          = (int)0x8046000F,
	SCE_PVF_ERROR_UNKNOWN          = (int)0x8046FFFF
} ScePvfErrorCode;
