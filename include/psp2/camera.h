...
typedef enum SceCameraErrorCode {
	SCE_CAMERA_ERROR_PARAM               = (int)0x802E0000,
	SCE_CAMERA_ERROR_ALREADY_INIT        = (int)0x802E0001,
	SCE_CAMERA_ERROR_NOT_INIT            = (int)0x802E0002,
	SCE_CAMERA_ERROR_ALREADY_OPEN        = (int)0x802E0003,
	SCE_CAMERA_ERROR_NOT_OPEN            = (int)0x802E0004,
	SCE_CAMERA_ERROR_ALREADY_START       = (int)0x802E0005,
	SCE_CAMERA_ERROR_NOT_START           = (int)0x802E0006,
	SCE_CAMERA_ERROR_FORMAT_UNKNOWN      = (int)0x802E0007,
	SCE_CAMERA_ERROR_RESOLUTION_UNKNOWN  = (int)0x802E0008,
	SCE_CAMERA_ERROR_BAD_FRAMERATE       = (int)0x802E0009,
	SCE_CAMERA_ERROR_TIMEOUT             = (int)0x802E000A,
	SCE_CAMERA_ERROR_EXCLUSIVE           = (int)0x802E000B,
	SCE_CAMERA_ERROR_ATTRIBUTE_UNKNOWN   = (int)0x802E000C,
	SCE_CAMERA_ERROR_MAX_PROCESS         = (int)0x802E000D,
	SCE_CAMERA_ERROR_NOT_ACTIVE          = (int)0x802E000E,
	SCE_CAMERA_ERROR_ALREADY_READ        = (int)0x802E000F,
	SCE_CAMERA_ERROR_NOT_MOUNTED         = (int)0x802E0010,
	SCE_CAMERA_ERROR_DATA_RANGE_UNKNOWN  = (int)0x802E0011,
	SCE_CAMERA_ERROR_OTHER_ALREADY_START = (int)0x802E0012,
	SCE_CAMERA_ERROR_FATAL               = (int)0x802E00FF
} SceCameraErrorCode;
