...
typedef enum SceAudioencErrorCode {
	SCE_AUDIOENC_ERROR_API_FAIL             = (int)0x80860000,
	SCE_AUDIOENC_ERROR_INVALID_TYPE         = (int)0x80860001,
	SCE_AUDIOENC_ERROR_INVALID_INIT_PARAM   = (int)0x80860002,
	SCE_AUDIOENC_ERROR_ALREADY_INITIALIZED  = (int)0x80860003,
	SCE_AUDIOENC_ERROR_OUT_OF_MEMORY        = (int)0x80860004,
	SCE_AUDIOENC_ERROR_NOT_INITIALIZED      = (int)0x80860005,
	SCE_AUDIOENC_ERROR_A_HANDLE_IN_USE      = (int)0x80860006,
	SCE_AUDIOENC_ERROR_ALL_HANDLES_IN_USE   = (int)0x80860007,
	SCE_AUDIOENC_ERROR_INVALID_PTR          = (int)0x80860008,
	SCE_AUDIOENC_ERROR_INVALID_HANDLE       = (int)0x80860009,
	SCE_AUDIOENC_ERROR_NOT_HANDLE_IN_USE    = (int)0x8086000A,
	SCE_AUDIOENC_ERROR_CH_SHORTAGE          = (int)0x8086000B,
	SCE_AUDIOENC_ERROR_INVALID_WORD_LENGTH  = (int)0x8086000C,
	SCE_AUDIOENC_ERROR_INVALID_SIZE         = (int)0x8086000D,
	SCE_AUDIOENC_ERROR_INVALID_ALIGNMENT    = (int)0x8086000E,
	SCE_AUDIOENC_ERROR_UNSUPPORTED          = (int)0x8086000F
} SceAudioencErrorCode;

typedef enum SceAudioencCelpErrorCode {
	SCE_AUDIOENC_CELP_ERROR_INVALID_CONFIG  = (int)0x80861001
