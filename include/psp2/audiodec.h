...
typedef enum SceAudiodecErrorCode {
	SCE_AUDIODEC_ERROR_API_FAIL                  = (int)0x807F0000,
	SCE_AUDIODEC_ERROR_INVALID_TYPE              = (int)0x807F0001,
	SCE_AUDIODEC_ERROR_INVALID_INIT_PARAM        = (int)0x807F0002,
	SCE_AUDIODEC_ERROR_ALREADY_INITIALIZED       = (int)0x807F0003,
	SCE_AUDIODEC_ERROR_OUT_OF_MEMORY             = (int)0x807F0004,
	SCE_AUDIODEC_ERROR_NOT_INITIALIZED           = (int)0x807F0005,
	SCE_AUDIODEC_ERROR_A_HANDLE_IN_USE           = (int)0x807F0006,
	SCE_AUDIODEC_ERROR_ALL_HANDLES_IN_USE        = (int)0x807F0007,
	SCE_AUDIODEC_ERROR_INVALID_PTR               = (int)0x807F0008,
	SCE_AUDIODEC_ERROR_INVALID_HANDLE            = (int)0x807F0009,
	SCE_AUDIODEC_ERROR_NOT_HANDLE_IN_USE         = (int)0x807F000A,
	SCE_AUDIODEC_ERROR_CH_SHORTAGE               = (int)0x807F000B,
	SCE_AUDIODEC_ERROR_INVALID_WORD_LENGTH       = (int)0x807F000C,
	SCE_AUDIODEC_ERROR_INVALID_SIZE              = (int)0x807F000D,
	SCE_AUDIODEC_ERROR_UNSUPPORTED               = (int)0x807F000E,
	SCE_AUDIODEC_ERROR_INVALID_NFRAMES           = (int)0x807F000F,
	SCE_AUDIODEC_ERROR_INVALID_NSTREAMS          = (int)0x807F0010,
	SCE_AUDIODEC_ERROR_DIFFERENT_TYPES           = (int)0x807F0011,
	SCE_AUDIODEC_ERROR_SAME_HANDLES              = (int)0x807F0012,
	SCE_AUDIODEC_ERROR_BUSY                      = (int)0x807F0013,
	SCE_AUDIODEC_AT9_ERROR_INVALID_CONFIG        = (int)0x807F2000,
	SCE_AUDIODEC_MP3_ERROR_INVALID_CH            = (int)0x807F2800,
	SCE_AUDIODEC_MP3_ERROR_INVALID_MPEG_VERSION  = (int)0x807F2801,
	SCE_AUDIODEC_AAC_ERROR_INVALID_CH            = (int)0x807F3000,
	SCE_AUDIODEC_CELP_ERROR_INVALID_CONFIG       = (int)0x807F3800
