...
typedef enum SceAtracErrorCode {
	SCE_ATRAC_ERROR_INVALID_POINTER               = (int)0x80630000,
	SCE_ATRAC_ERROR_INVALID_SIZE                  = (int)0x80630001,
	SCE_ATRAC_ERROR_INVALID_WORD_LENGTH           = (int)0x80630002,
	SCE_ATRAC_ERROR_INVALID_TYPE                  = (int)0x80630003,
	SCE_ATRAC_ERROR_INVALID_TOTAL_CH              = (int)0x80630004,
	SCE_ATRAC_ERROR_INVALID_ALIGNMENT             = (int)0x80630005,
	SCE_ATRAC_ERROR_ALREADY_CREATED               = (int)0x80630006,
	SCE_ATRAC_ERROR_NOT_CREATED                   = (int)0x80630007,
	SCE_ATRAC_ERROR_SHORTAGE_OF_CH                = (int)0x80630008,
	SCE_ATRAC_ERROR_UNSUPPORTED_DATA              = (int)0x80630009,
	SCE_ATRAC_ERROR_INVALID_DATA                  = (int)0x8063000A,
	SCE_ATRAC_ERROR_READ_SIZE_IS_TOO_SMALL        = (int)0x8063000B,
	SCE_ATRAC_ERROR_INVALID_HANDLE                = (int)0x8063000C,
	SCE_ATRAC_ERROR_READ_SIZE_OVER_BUFFER         = (int)0x8063000D,
	SCE_ATRAC_ERROR_MAIN_BUFFER_SIZE_IS_TOO_SMALL = (int)0x8063000E,
	SCE_ATRAC_ERROR_SUB_BUFFER_SIZE_IS_TOO_SMALL  = (int)0x8063000F,
	SCE_ATRAC_ERROR_DATA_SHORTAGE_IN_BUFFER       = (int)0x80630010,
	SCE_ATRAC_ERROR_ALL_DATA_WAS_DECODED          = (int)0x80630011,
	SCE_ATRAC_ERROR_INVALID_MAX_OUTPUT_SAMPLES    = (int)0x80630012,
	SCE_ATRAC_ERROR_ADDED_DATA_IS_TOO_BIG         = (int)0x80630013,
	SCE_ATRAC_ERROR_NEED_SUB_BUFFER               = (int)0x80630014,
	SCE_ATRAC_ERROR_INVALID_SAMPLE                = (int)0x80630015,
	SCE_ATRAC_ERROR_NO_NEED_SUB_BUFFER            = (int)0x80630016,
	SCE_ATRAC_ERROR_INVALID_LOOP_STATUS           = (int)0x80630017,
	SCE_ATRAC_ERROR_REMAIN_VALID_HANDLE           = (int)0x80630018,
	SCE_ATRAC_ERROR_INVALID_LOOP_NUM              = (int)0x80630030
} SceAtracErrorCode;
