...
typedef enum SceSslErrorCode {
	SCE_SSL_ERROR_BEFORE_INIT    = (int)0x80435001,
	SCE_SSL_ERROR_ALREADY_INITED = (int)0x80435020,
	SCE_SSL_ERROR_OUT_OF_MEMORY  = (int)0x80435022,
	SCE_SSL_ERROR_NOT_FOUND      = (int)0x80435025,
	SCE_SSL_ERROR_INTERNAL       = (int)0x80435026,
	SCE_SSL_ERROR_INVALID_FORMAT = (int)0x80435108,
	SCE_SSL_ERROR_INVALID_VALUE  = (int)0x804351FE
} SceSslErrorCode;
