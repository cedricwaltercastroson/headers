...
typedef enum SceFontErrorCode {
	SCE_FONT_ERROR_OUT_OF_MEMORY        = (int)0x80460001,
	SCE_FONT_ERROR_INVALID_LIBID        = (int)0x80460002,
	SCE_FONT_ERROR_INVALID_PARAMETER    = (int)0x80460003,
	SCE_FONT_ERROR_HANDLER_OPEN_FAILED  = (int)0x80460005,
	SCE_FONT_ERROR_TOO_MANY_OPEN_FONTS  = (int)0x80460009,
	SCE_FONT_ERROR_INVALID_FONT_DATA    = (int)0x8046000A,
} SceFontErrorCode;
