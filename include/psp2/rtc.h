...
typedef enum SceRtcErrorCode {
	SCE_RTC_ERROR_INVALID_VALUE        = (int)0x80251000,
	SCE_RTC_ERROR_INVALID_POINTER      = (int)0x80251001,
	SCE_RTC_ERROR_NOT_INITIALIZED      = (int)0x80251002,
	SCE_RTC_ERROR_ALREADY_REGISTERD    = (int)0x80251003,
	SCE_RTC_ERROR_NOT_FOUND            = (int)0x80251004,
	SCE_RTC_ERROR_BAD_PARSE            = (int)0x80251080,
	SCE_RTC_ERROR_INVALID_YEAR         = (int)0x80251081,
	SCE_RTC_ERROR_INVALID_MONTH        = (int)0x80251082,
	SCE_RTC_ERROR_INVALID_DAY          = (int)0x80251083,
	SCE_RTC_ERROR_INVALID_HOUR         = (int)0x80251084,
	SCE_RTC_ERROR_INVALID_MINUTE       = (int)0x80251085,
	SCE_RTC_ERROR_INVALID_SECOND       = (int)0x80251086,
	SCE_RTC_ERROR_INVALID_MICROSECOND  = (int)0x80251087
} SceRtcErrorCode;
