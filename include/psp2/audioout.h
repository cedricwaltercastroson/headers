...
typedef enum SceAudioOutErrorCode {
	SCE_AUDIO_OUT_ERROR_NOT_OPENED          = (int)0x80260001,
	SCE_AUDIO_OUT_ERROR_BUSY                = (int)0x80260002,
	SCE_AUDIO_OUT_ERROR_INVALID_PORT        = (int)0x80260003,
	SCE_AUDIO_OUT_ERROR_INVALID_POINTER     = (int)0x80260004,
	SCE_AUDIO_OUT_ERROR_PORT_FULL           = (int)0x80260005,
	SCE_AUDIO_OUT_ERROR_INVALID_SIZE        = (int)0x80260006,
	SCE_AUDIO_OUT_ERROR_INVALID_FORMAT      = (int)0x80260007,
	SCE_AUDIO_OUT_ERROR_INVALID_SAMPLE_FREQ = (int)0x80260008,
	SCE_AUDIO_OUT_ERROR_INVALID_VOLUME      = (int)0x80260009,
	SCE_AUDIO_OUT_ERROR_INVALID_PORT_TYPE   = (int)0x8026000A,
	SCE_AUDIO_OUT_ERROR_INVALID_FX_TYPE     = (int)0x8026000B,
	SCE_AUDIO_OUT_ERROR_INVALID_CONF_TYPE   = (int)0x8026000C,
	SCE_AUDIO_OUT_ERROR_OUT_OF_MEMORY       = (int)0x8026000D
