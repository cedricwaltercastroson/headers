...
SceInt32 ksceKernelInitializeFastMutex(
	SceKernelFastMutexWork *pWork,
	const char *pName,
	SceKernelFastMutexAttr attr,
	const SceKernelFastMutexOptParam *pOptParam);

SceInt32 ksceKernelLockFastMutex(SceKernelFastMutexWork *pWork);

SceInt32 ksceKernelTryLockFastMutex(SceKernelFastMutexWork *pWork);

SceInt32 ksceKernelUnlockFastMutex(SceKernelFastMutexWork *pWork);

SceInt32 ksceKernelFinalizeFastMutex(SceKernelFastMutexWork *pWork);
...
SceInt32 ksceKernelGetFastMutexInfo(SceKernelFastMutexWork *pWork, SceKernelFastMutexInfo *pInfo);

SceInt32 ksceKernelGetFastMutexInfoById(SceUID uid, SceKernelFastMutexInfo *pInfo);
