...
/**
 * See ksceIoChstat(), ksceIoGetstat(), ksceIoChstatByFd(), ksceIoGetstatByFd()
 */
...
/**
  ...
  * @return < 0 on error.
  */
int ksceIoChstat(const char *name, const SceIoStat *buf, unsigned int cbit);
...
/**
  ...
  * @return < 0 on error.
  */
int ksceIoGetstat(const char *name, SceIoStat *buf);
...
/**
  ...
  * @return < 0 on error.
  */
int ksceIoGetstatByFd(SceUID fd, SceIoStat *buf);
