...
typedef enum SceJpegEncErrorCode {
	SCE_JPEGENC_ERROR_IMAGE_SIZE                = (int)0x80650200,
	SCE_JPEGENC_ERROR_INSUFFICIENT_BUFFER       = (int)0x80650201,
	SCE_JPEGENC_ERROR_INVALID_COMPRATIO         = (int)0x80650202,
	SCE_JPEGENC_ERROR_INVALID_PIXELFORMAT       = (int)0x80650203,
	SCE_JPEGENC_ERROR_INVALID_HEADER_MODE       = (int)0x80650204,
	SCE_JPEGENC_ERROR_INVALID_POINTER           = (int)0x80650205,
	SCE_JPEGENC_ERROR_NOT_PHY_CONTINUOUS_MEMORY = (int)0x80650206
} SceJpegEncErrorCode;
